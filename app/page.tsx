...
export const metadata = createMetadata({
  ...
  description:
    "Хъб за Devids: бизнес и технологични инсайти, уроци и истории от екипа – воден от двама основатели под 20.",
  keywords: [
    "Devids",
    "Devids software company Bulgaria",
    "Devids Bulgaria software development company",
    "Devids software company Bulgaria projects",
    "Devids Давид Петков Давид Христов",
    "Devids България IT награди",
    "Devids software company стартъп история",
    "David",
    "Бърза разработка на сайт",
    "Качествен софтуер",
    "бизнес",
    "технологии",
    "продукт",
    ...
    "stox.bg",
    "България софтуер",
    "IT компания България",
    "младежки предприемачи",
...
export default async function Home() {
  ...
  const latestPost: HomePost | null =
    latestPostArr && latestPostArr.length > 0
      ? (latestPostArr[0] as HomePost)
      : null;
  ...
  const findCategoryIdByName = (names: string[]): number | undefined => {
    ...
    const match = allCategories.find((c) =>
      lowerNames.some((n) => c.name?.toLowerCase().startsWith(n)),
    );
  ...
  return (
    <div className="relative bg-background text-foreground">
      ...
      <div className="relative bg-secondary text-center py-2 px-4 text-sm text-muted-foreground border-b border-border">
        <p>
          stox.bg – проект на Devids. Прочетете повече{" "}
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-tight mb-6">
                Истории за <span className="text-primary">бизнес</span> и{" "}
                <span className="text-primary">технологии</span>
              </h1>

              <p className="text-lg text-muted-foreground max-w-xl mb-8 leading-relaxed">
                stox.bg е дом за постиженията и уроците на Devids – как двама
                основатели водим екип и изграждаме продукти.
              </p>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <div className="text-center">
                <p className="text-muted-foreground">
                  Скоро ще добавим първа публикация
                </p>
              </div>
            </div>
          )}
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="flex justify-between items-center mb-10">
            <div>
              ...
              <p className="text-muted-foreground">
                Практични уроци от изграждането на компания
              </p>
            </div>
            <Link
              href="/business"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {businessPosts && businessPosts.length > 0
              ? businessPosts.map((post: HomePost) => (
                  <Link
                    key={post.id}
                    href={`/c/${post.slug}`}
              ...
              : Array.from({ length: 3 }).map((_, index) => (
                  <div
                    key={index}
                    className="bg-card border border-border rounded-xl p-6 h-full min-h-[400px] flex flex-col"
                  >
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="flex justify-between items-center mb-10">
            <div>
              ...
              <p className="text-muted-foreground">
                Инженерни практики, архитектури и продуктова разработка
              </p>
            </div>
            <Link
              href="/technology"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {technologyPosts && technologyPosts.length > 0
              ? technologyPosts.map((post: HomePost) => (
                  <Link
                    key={post.id}
                    href={`/c/${post.slug}`}
                    className="group block h-full"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Как взимаме решения, какво научаваме и как изграждаме продукти.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Реални практики – от стратегия и процеси до архитектура и код.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Елегантни решения, чист код и практична полезност преди всичко.
              </p>
            </div>
          </div>
        </div>
